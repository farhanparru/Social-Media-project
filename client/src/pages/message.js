        ...
        <div class="card mask-custom">
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-0">
              <li class="p-2 border-bottom" style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.3) !important' }}>
              ...
              <li class="p-2 border-bottom" style={{borderbottom: '1px solid rgba(255,255,255,.3) !important'}}>
                <a href="#!" class="d-flex justify-content-between link-light">
                  <div class="d-flex flex-row">
